...
#
# model-cache must exist here, owned by openindex: Docker seeds a named volume
# from the image's directory (including its ownership) only when the mount point
